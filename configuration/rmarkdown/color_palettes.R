time_palette <-  alpha(colorblindr::palette_OkabeIto[c(3,2,5,4,1,6)], 0.8)
names(time_palette) <- c('0', '30', '60', '120', '240', '480')

condition_palette <- c(Control = 'grey80', Chip = 'black')
condition_palette_red <- c(Control = 'grey80', Chip = '#D55E00')
condition_shape = c( Control = 8, Chip = 19)

donor_palette <- c(BR16 = "#739C83", BRx07 = "#CF6C59", BRx50 = "#D6B465")


ctc_type_palette <- c(ctc_cluster = '#f46d43',
                      ctc_single = '#66bd63',
                      ctc_single_from_broken_clusters = '#fee08b')
